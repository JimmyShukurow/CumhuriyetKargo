...
Route::group(['prefix' => 'Operation'], function () {
    ...
    Route::group(['middleware' => 'LocalLocationMid'], function () {
        ...
        Route::get('LocalLocationGetTrGeneralLocations', [LocalLocationController::class, 'GetTrGeneralLocations'])->name('location.GetTrGeneralLocations');
        Route::get('LocalLocationGetAgencyLocationStatus', [LocalLocationController::class, 'getAgencyLocationStatus'])->name('location.getAgencyLocationStatus');
        Route::post('LocalLocationGetAgencyLocations', [LocalLocationController::class, 'getAgencyLocations'])->name('location.getAgencyLocations');

        Route::post('GetLocationInfo', [LocalLocationController::class, 'getLocationInfo']);
        Route::post('EditLocalLocation', [LocalLocationController::class, 'updateLocation']);
