...
@section('title', 'Yeni Kullanıcı Oluştur (Acente)')
    ...
    <div class="app-main__inner">
            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Yeni Kullanıcı Oluştur
                        <div class="page-title-subheading">Bu sayfa üzerinden {{ $data['agencies']->agency_name }}
                            Acentesi için sisteme giriş yapabilecek yeni
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form id="UserForm" method="POST" action="{{ route('AgencyUsers.store') }}">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div id="agency_block" class="position-relative form-group">
                                ...
                                <select name="agency" disabled id="agency" required class="form-control">
                                    <option
                                        value="">{{$data['agencies']->city . '/' . $data['agencies']->district . '-'. $data['agencies']->agency_name . ' ACENTE'}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
