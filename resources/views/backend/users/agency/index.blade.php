...
@section('title', $data['agencies']->agency_name . ' Acente Kullanıcıları')
            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Tüm Kullanıcılar
                        ...
                        <div class="page-title-subheading">Bu modül üzerinden
                            sistemdeki {{$data['agencies']->agency_name}} acentenize bağlı tüm kullanıcıları
                ...
                <div class="page-title-actions">
                    <div class="d-inline-block dropdown">
                        <a href="{{ route('AgencyUsers.create') }}">
        ...
        <div class="card mb-3">
            <div class="card-header-tab card-header">
                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i
                    ...
                    Tüm Kullanıcılar {{$data['agencies']->agency_name . ' ('. $data['agencies']->agency_code .')'}}
                </div>
            </div>
                ...
                <table class="NikolasDataTable align-middle mb-0 table table-borderless table-striped table-hover ">
                    ...
                    @foreach ($data['users'] as $user)
                        <tr id="AgencyUser-item-{{ $user->id }}">
                            ...
                            <td>{{$data['agencies']->agency_code }}</td>
                                ...
                                <div class="dropdown d-inline-block">
                                    ...
                                    <div
                                        ...
                                        <a class="dropdown-item"
                                           href="{{ route('AgencyUsers.edit', $user->id) }}">
                                            Düzenle
                                        </a>
                                        <button type="button" id="{{ $user->id }}" tabindex="0" from="AgencyUser"
            ...
            $('.NikolasDataTable').DataTable({
                ...
                buttons: [
                    ...
                    'print',
                    {
                        ...
                        title: "CK-{{$data['agencies']->agency_name . '  - '. $data['agencies']->agency_code}} Acente Kullanıcıları"
                    }
                ],
                responsive: true,
                scrollY: '750px',
