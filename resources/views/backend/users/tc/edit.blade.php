...
@section('title', $data['transshipment_centers']->tc_name . ' Aktarma Kullanıcı Düzenle')
    ...
    <div class="app-main__inner">
            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Kullanıcı Düzenle
                        <div class="page-title-subheading">Bu sayfa üzerinden {{ $tc->tc_name }}
                            Transfer Merkezi için kullanıcılarınızı düzenleyebilirsiniz.
                        </div>
                    </div>
                </div>
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form id="UserForm" method="POST" action="{{ route('TCUsers.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        <div class="col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div id="agency_block" class="position-relative form-group">
                                <label for="agency" class="">Transfer Merkezi*</label>
                                <select name="agency" disabled id="agency" required class="form-control">
                                    <option
                                        value="">{{$tc->city . '/' . $tc->district . '-'. $tc->tc_name }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <button
                                onclick="confirmBox('Parola Sıfırlama İşlemini Onaylayın.', 'Kullanıcının şifresi sıfırlanacak ve sisteme kayıtlı telefon numarasına sms olarak gönderilecektir, bunu onaylıyor musunuz?','{{route('TCUsers.passwordReset', ['id' => Crypte4x($data->id)])}}')"
                                type="button"
