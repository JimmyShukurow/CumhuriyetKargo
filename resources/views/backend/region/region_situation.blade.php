                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>
                                    ...
                                    <div class="page-title-subheading">Bu modül üzerinden bölgenize bağlı
                                        acentelerinizin kesmiş olduğu kargoları, ciroyu vs görebilirsiniz.
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="widget-content-outer">
                                                <div class="widget-content-wrapper">
                                                    <div class="widget-content-left">
                                                        ...
                                                        <div class="widget-subheading">(Bugün) Toplam Kesilen Kargo
                                                            Adeti
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="widget-content-outer">
                                                <div class="widget-content-wrapper">
                                                    <div class="widget-content-left">
                                                        ...
                                                        <div class="widget-subheading">(Bugün) Toplam Kesilen Dosya
                                                        </div>
                                                    </div>
                                                    <div class="widget-content-right">
                                                        <div id="file_count"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="statusForHuman" id="statusForHuman"
                                        ...
                                        @foreach($data['status_for_human'] as $key)
                                            <option
                                                value="{{$key->status_for_human}}">{{$key->status_for_human}}</option>
                                        @endforeach
                                    </select>
                                </div>
...
@section('js')
    ...
    <script src="/backend/assets/scripts/region/situation.js"></script>
