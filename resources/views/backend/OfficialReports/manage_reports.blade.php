        ...
        <div class="card mt-3">
            <div class="card-header-tab card-header">
                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i
                        class="header-icon pe-7s-note2 mr-3 text-muted opacity-6"> </i> Tutanak Yönetim &nbsp;
                    <b>[{{$unit}}]</b>
                </div>
            ...
            <div class="card-body">
                <form method="POST" id="search-form">
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="col-md-4">
                           <button id="btnConfirmSelected" confirm="yes" type="button" class="btn-confirm-report btn btn-success">Seçilenleri Onayla</button>
                        </div>
                        <div class="col-md-4">
                            <button type="button" confirm="no" class="btn-confirm-report btn btn-danger">Seçilenleri Onaylama</button>
                        </div>
                    </div>
                </form>
            </div>
