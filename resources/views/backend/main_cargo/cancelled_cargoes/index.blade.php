...
@section('title', 'İptal Edilen Kargolar')
@section('content')
        ...
        <div class="card mt-3">
            <div class="card-header-tab card-header">
                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i
                        class="header-icon pe-7s-box2 mr-3 text-muted opacity-6"> </i> CKG-Sis İptal Edilen Kargolarınız
                </div>
...
@section('js')
    ...
    <script src="/backend/assets/scripts/main-cargo/cancelled-cargoes.js"></script>
    <script>var typeOfJs = 'cancelled_cargo'; </script>
