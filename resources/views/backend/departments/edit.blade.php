...
@section('content')
    ...
    <div class="app-main__inner">
            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div class="page-title-icon">
                        <i class="lnr-briefcase icon-gradient bg-amy-crisp">
                        </i>
                    </div>
                    <div>Departman Düzenle
                        <div class="page-title-subheading">Bu sayfa üzerinden departmanları düzenleyebilirsiniz.
                        </div>
                    </div>
                </div>
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">Departman Düzenle</h5>
                <form id="agencyForm" method="POST" action="{{ route('Departments.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        <div class="col-md-12">
                            <div class="position-relative form-group">
                                ...
                                <input name="department_name" required id="department_name"
                                       ...
                                       value="{{ $data->department_name }}" class="form-control">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="position-relative form-group">
                                ...
                                <textarea name="explantion" id="" placeholder="Deparman açıklaması giriniz."
                                          ...
                                          class="form-control">{{ $data->department_name }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="ladda-button mb-2 mr-2 btn btn-gradient-primary"
                        ...
                        <span class="ladda-label">Departmanı Düzenle</span>
