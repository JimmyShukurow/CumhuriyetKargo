<div class="dropdown d-inline-block">
    ...
    <div
        ...
        <a class="dropdown-item cargo-detail IdenticalButton" id="IdenticalButton" href="javascript:void(0)">Detay</a>
        <a class="dropdown-item" href="{{ route('tutorial.edit', $id) }}">Düzenle</a>
        <button type="button" id="{{ $id }}" tabindex="0" from="current" class="dropdown-item deleteTutorial" onclick="deleteTutorial({{ $id }})"> Sil</button>
    </div>
</div>
