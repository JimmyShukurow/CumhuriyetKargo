...
@section('title', 'Muhtelif Araçlar')
        ...
        <div class="card-body">
            <form method="POST" id="search-form">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label for="recordDate">Kayıt Tarihi:</label>
                        <input type="datetime-local" id="recordDate" value="{{ date('Y-m-d') }}T00:00"
                               class="form-control form-control-sm  niko-select-filter">
                    </div>
