...
@section('title', 'Acente Aracı Degiştir')
...
@section('content')
    <div class="app-main__inner">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <form id="tc_car_form" method="POST" action="/TCCars/{{$car->id}}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="position-relative form-group">
                                        ...
                                        <select name="hat" required id="hat" placeholder="Hattı giriniz." type="text" class="form-control form-control form-control-sm">
                                            ...
                                            <option {{old('hat')  == 'Anahat' || $car->hat == 'Anahat' ? 'selected' : ''}} value="Anahat">
                                                Anahat
                                            </option>
                                            <option {{old('hat') == 'Arahat' || $car->hat == 'Arahat' ? 'selected' : ''}} value="Arahat">
                                                Arahat
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="position-relative form-group">
                                        ...
                                        <select name="arac_kapasitesi" required id="arac_kapasitesi" placeholder="Araç kapasitesini giriniz." type="text"class="form-control form-control form-control-sm">
                                            <option value=""> Seçiniz</option>
                                            <option
                                                {{old('arac_kapasitesi') == 'Panelvan' || $car->arac_kapasitesi == 'Panelvan' ? 'selected' : ''}} value="Panelvan">
                                                Panelvan
                                            </option>
                                            <option
                                                {{old('arac_kapasitesi') == 'Kamyonet' || $car->arac_kapasitesi == 'Kamyonet' ? 'selected' : ''}} value="Kamyonet">
                                                Kamyonet
                                            </option>
                                            <option
                                                {{old('arac_kapasitesi') == '6 Teker Kamyonet' || $car->arac_kapasitesi == '6 Teker Kamyonet'  ? 'selected' : ''}} value="6 Teker Kamyonet">
                                                6 Teker Kamyonet
                                            </option>
                                            <option
                                                {{old('arac_kapasitesi') == '10 Teker Kamyonet' || $car->arac_kapasitesi == '10 Teker Kamyonet' ? 'selected' : ''}} value="10 Teker Kamyon">
                                                10 Teker Kamyon
                                            </option>
                                            <option
                                                {{old('arac_kapasitesi') == '40 Ayak Kamyon' || $car->arac_kapasitesi == '40 Ayak Kamyon' ? 'selected' : ''}} value="40 Ayak Kamyon">
                                                40 Ayak Kamyon
                                            </option>
                                        </select>
                                    </div>
                                        ...
                                        <select name="cikis_aktarma" required id="cikis_aktarma"
                                               ...
                                               <option value=""> Seçiniz</option>
                                                @foreach($transshipment_centers as $trasferCars)
                                                    <option
                                                        {{old('cikis_aktarma') == $trasferCars->id || $car->cikis_aktarma == $trasferCars->id ? 'selected' : ''}}
                                    ...
                                    <div class="position-relative form-group">
                                        ...
                                        <select name="varis_aktarma" required id="varis_aktarma"
                                               ...
                                               <option value=""> Seçiniz</option>
                                                @foreach($transshipment_centers as $trasferCars)
                                                    <option
                                                        {{old('varis_aktarma') == $trasferCars->id || $car->varis_aktarma == $trasferCars->id ? 'selected' : ''}}
                                                        value="{{$trasferCars->id}}">{{$trasferCars->tc_name.' T.M.'}} </option>
                                                @endforeach
                                        </select>
                                    </div>
