...
@section('content')
    ...
    <div class="app-main__inner">
            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div class="page-title-icon">
                        <i style="line-height: 10px;"
                           class="ion-android-color-palette pe-3x icon-gradient bg-ripe-malin">
                        </i>
                    </div>
                    <div>Sistem Teması
                        <div class="page-title-subheading">Bu sayfa üzerinden sistem temasını ayarlayabilirsiniz.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="main-card mb-3 card min-vh-100">
            <div class="card-body">
