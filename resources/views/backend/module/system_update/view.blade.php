...
@section('content')
    ...
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>CKG-Sis Sistem Güncellemeleri
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 style="text-transform: none"  class="card-title">CKG-Sis Sistem Version Geçmişi</h5>
                <div class="card-body">
                    <div style="overflow-x: auto;">
                        <table style="width: 100%; white-space: nowrap;"
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn mr-2 mb-2 btn-primary text-white openModal"
                                            data-toggle="modal" data-target=".bd-example-modal-lg"
                                            data-target2="{{ $d->id }}">Detay
                                    </button>
                                </td>
                            </tr>
                            @endforeach
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                Sistemle ilgili şikayet ve önerilerinizi Destek & Ticket Modülü üzerinden Yazılım Departmanına
                iletibilirsiniz. Ayrıca <a href="{{route('systemSupport.NewTicket')}}">buraya</a> tıklayarak destek
                talebi üzerinden iletibilirsiniz görüşlerinizi.
            </div>
        </div>
