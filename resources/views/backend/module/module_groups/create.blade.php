...
@section('title', 'Yeni Modül Grubu Girişi')
...
@section('content')
    ...
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Yeni Modül Grubu Ekle
                        <div class="page-title-subheading">Bu sayfa üzerinden modül grubu oluşturabilirsiniz.
                        </div>
                    </div>
                </div>
        ...
        <div class="main-card mb-3 card">
            <div class="card-body"><h5 class="card-title">MODÜL GRUBU EKLE</h5>
                <form method="POST" action="{{route('module.ModuleGroup')}}">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="position-relative form-group">
                                ...
                                <input name="title" id="rolename"
                                       ...
                                       type="text" required value="{{old('title')}}"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <button type="submit" class="ladda-button mb-2 mr-2 btn btn-gradient-primary"
                        ...
                        <span class="ladda-label">Yeni Modül Grubu Ekle</span>
