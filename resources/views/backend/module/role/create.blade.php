...
@section('title', 'Yeni Yetki Girişi')
    ...
    <div class="app-main__inner">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body"><h5 class="card-title">YETKİ EKLE</h5>
                <form method="POST" action="{{route('module.InsertRole')}}">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="position-relative form-group">
                                ...
                                <input name="display_name"
                                       ...
                                       type="text" required value="{{old('display_name')}}"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="ladda-button mb-2 mr-2 btn btn-gradient-primary"
                        ...
                        <span class="ladda-label">Yeni Yetki Ekle</span>
