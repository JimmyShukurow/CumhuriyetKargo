...
@section('title', 'Hesap hareketleriniz')
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div> Hesap hareketleriniz (Logs)
                        <div class="page-title-subheading">Hesabınızda gerçekleşen son hareketleri buradan
                            listeleyebilirsiniz.
                        </div>
                    </div>
                </div>
        ...
        <div class="card mb-3">
            <div class="card-header-tab card-header">
                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i
                        class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>Hesabınıza Ait Son
                    Hareketler
                </div>
            ...
            oTable = $('.NikolasDataTable').DataTable({
                ...
                buttons: [
                    'copy',
                    {
                        ...
                        title: "CK- {{ Auth::user()->name_surname }} Hesap Hareketleri"
                    },
                    {
                        text: 'Yenile',
                ...
                serverSide: true,
                ajax: {
                    url: '{!! route('personel.GetLastLogs') !!}',
                    data: function (d) {
...
@section('modals')
    ...
    <!-- Large modal -->
    <div class="modal fade bd-example-modal-lg" id="ModalLogProperties" tabindex="-1"
         role="dialog"
                                ...
                                <div class="dropdown-menu-header-inner bg-dark">
                                    ...
                                    <div class="menu-header-content btn-pane-right">
                                        ...
                                        <div>
                                            ...
                                            <h6 id="userAgency" class="menu-header-subtitle">
                                                ###/###</h6>
                                        </div>
                                    ...
                                    <div class="widget-content pt-4 pb-4 pr-1 pl-1">
                                        ...
                                        <div style="overflow-x: scroll" class="cont">
                                            <table style="white-space: nowrap" id="AgencyCard"
                                                ...
                                                <thead>
                                                <tr>
                                                    <th class="text-center" colspan="2">Log
                                                        Detayları
                                                    </th>
                                                </tr>
                                                </thead>
