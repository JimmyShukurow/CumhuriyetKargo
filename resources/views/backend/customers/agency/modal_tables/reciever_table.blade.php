<table style="white-space: nowrap; display:none" id="AgencyCard"
       class="TableNoPadding table table-bordered table-striped taker-table-display">
    {{-- Alici --}}
    <thead>
    <tr>
    ...
    <tbody class="reciever">

    <tr>
        <td style="padding-right: 100px;" class="static">TCKN</td>
        <td style="width: 100% !important;" id="tcknTaker"></td>
    </tr>
