<table id="AgencyCard" class="TableNoPadding table table-bordered table-striped sender-personal-display">
    {{-- Gonderici bireysel --}}
    <thead>
    <tr>
    ...
    <tbody class="sender-personal">
    <tr>
        <td style="padding-right: 100px;" class="static">Müşteri Tipi</td>
        <td style="width: 100% !important;" id="senderPersonalCustomerType-1" class="text-success"></td>
    </tr>
